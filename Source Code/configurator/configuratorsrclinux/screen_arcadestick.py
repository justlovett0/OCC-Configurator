...
class ArcadeStickApp:
    ...
    def _connect_xinput(self):
        ...
        if not controllers:
            messagebox.showwarning("No Controllers", "No supported play-mode controllers were detected. If the arcade stick is in HID mode, hold Start + Select + Guide while plugging it in to enter config mode.")
            return
