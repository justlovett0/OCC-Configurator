 ...
 * v12: Added sync_pin for dongle pairing button. Changed DEVICE_TYPE to
 *      guitar_alternate_dongle for dongle-mode firmware identification.
 */
...
// "guitar_alternate_dongle" tells the configurator this guitar uses a wireless dongle
#define DEVICE_TYPE               "guitar_alternate_dongle"
