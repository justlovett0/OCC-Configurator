/*
 * usb_descriptors.h - XInput Pedal Controller USB Descriptor Definitions
 *
 * The pedal presents as a Guitar Alternate (0x07) XInput device to the
 * host PC, passing through inputs from a connected guitar controller
 * and merging its own pedal button presses.
 */
