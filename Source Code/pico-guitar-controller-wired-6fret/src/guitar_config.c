...
void config_set_defaults(guitar_config_t *config) {
    ...
    config->pin_buttons[BTN_IDX_WHITE_1]    = 0;
    config->pin_buttons[BTN_IDX_BLACK_1]    = 1;
    config->pin_buttons[BTN_IDX_BLACK_2]    = 2;
    config->pin_buttons[BTN_IDX_BLACK_3]    = 3;
    config->pin_buttons[BTN_IDX_WHITE_2]    = 4;
    config->pin_buttons[BTN_IDX_WHITE_3]    = 5;
    config->pin_buttons[BTN_IDX_STRUM_UP]   = 6;
    config->pin_buttons[BTN_IDX_STRUM_DOWN] = 7;
    config->pin_buttons[BTN_IDX_START]      = 8;
    config->pin_buttons[BTN_IDX_HERO_POWER] = 9;
    config->pin_buttons[BTN_IDX_GHTV]       = -1;
    ...
    // Default colors: white-row then black-row frets.
    ...
    // Default device name
    strncpy(config->device_name, "OCC 6-Fret Guitar", DEVICE_NAME_MAX);
